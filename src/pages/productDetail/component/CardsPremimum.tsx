...
const CardsPremimum = () => {
  ...
  const handleChange = (e: any) => {
    setProduct({
      ...product,
      [e.target.name]: e.target.name === "title" ? e.target.value.toUpperCase() : product[e.target.name]
    })
    setCardData({
      ...cardData,
      [e.target.name]: e.target.name !== "logo" ? e.target.value.toUpperCase() : fileReader.readAsDataURL(e.target.files[0])
    })
  }
        ...
        <div className="flex relative mt-20 py-5 max-lg:flex-col">
          ...
          <div className="lg:w-[50%] max-lg:w-full">
            ...
            <div className="w-full">
              ...
              <div
                className="bg-[#171717] shadow-[inset_-8px_-9px_11px_rgba(30,30,30,0.25),inset_6px_7px_10px_#000000] rounded-[10px] p-2 flex items-center w-full">
                {option.map((el, idx) => (
                  <div key={idx}>
                    <div onClick={() => {
            ...
            <div>
              ...
              <div className="my-3">
                ...
                <div
                  className="w-[65%] bg-[rgba(54,54,56,0.5)] shadow-[0px_2px_10px_rgba(0,0,0,0.25)] px-2 py-3 text-[16px] text-[rgba(255,255,255,0.27)] rounded-[10px]">
                  <input
                    onChange={handleChange}
                    id="input_file"
                    type="file"
