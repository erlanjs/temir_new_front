                        ...
                        name.map(el => (
                            <div className="w-[80%] md:w-[40%]">
                                ...
                                <input type="text" placeholder={el.title}
                                       className="focus:shadow-lg focus:shadow-gray-700 w-[100%] py-1.5 bg-transparent border-b-2 placeholder-gray-500 mb-7 outline-0 pl-1.5"/>
                            </div>
                        ))
                    }

                    <button className="md:w-56 md:h-14 w-40 h-10  bg-black font-normal text-lg text-white my-10 rounded-md hover:scale-110 hover:bg-transparent transition duration-500 ease-in-out" style={{
