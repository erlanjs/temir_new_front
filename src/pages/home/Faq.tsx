        ...
        <section id="faq">
            <div className="container">
                {/*ml-[150px] mt-[100px] w-[100%]*/}
                    <h1 className="font-bold text-7xl tracking-tight mb-14 max-md:text-6xl max-[390px]:text-[40px] max-[390px]:pb-20">How it works</h1>
                    <div className="flex items-start justify-between relative py-10 flex-wrap ">
                        <div className="max-[834px]:flex max-[834px]:flex-row-reverse max-[834px]:items-start max-[834px]:justify-between max-[834px]:w-[100%]">
                            <div className="flex items-center max-[390px]:w-[80%] max-[390px]:flex-col items-start max-[390px]:w-[23%] max-[834px]:flex-col max-[834px]:mt-32">
                                <div className="flex items-center justify-center flex-col mr-16 max-[390px]:mr-6 max-[390px]:mr-0] max-[390px]:flex max-[390px]:justify-center max-[390px]:mb-5 max-[834px]:mb-5">
                                    <img src={faqLogo1} alt="img"/>
                                    <h5 className="mt-3.5 max-[390px]:text-[10px]">Tap your card</h5>
                                </div>
                                <div className="flex items-center justify-center flex-col mr-16 max-[390px]:mr-6 max-[390px]:mr-0] max-[390px]:flex max-[390px]:justify-center max-[390px]:mb-5 max-[834px]:mb-5">
                            ...
                            <div className="pb-40">
                                <h1 className="font-bold text-3xl text-[#B3B3B3] text-center w-[387px] py-10 max-[390px]:text-left">FAQ</h1>
                                <div className="border-l-2 pl-2.5 ">
                                    <Fragment>
                                        <div className="md:w-[387px] max-md:w-[60%] max-[390px]:w-[80%]  mb-2.5  rounded  flex items-center justify-center flex-col">
                                            <Accordion open={open === 1} icon={<Icon id={1} open={open}/>}>
                                                <div className="px-3 bg-[#1A1919] rounded rounded-tr-[30px]">
                                                    <AccordionHeader onClick={() => handleOpen({value: 1})}
                                                                     className='bg-transparent text-left max-[390px]:text-[14px]'>
                        ...
                        <div className="">
                            <div className="border-l-2 flex items-start pl-2.5 max-[834px]:w-[60%] max-[834px]:top-[700px] max-[834px]:right-[267px] absolute right-0 top-[-110px] max-[390px]:w-[100%] ">
                                <h1>•</h1>
                            ...
                            <div className="">
                                ...
                                <img src={iphone} alt="img"
                                     className="absolute right-[-152px] top-10
                                      max-[390px]:right-[-38px] max-[390px]:w-[80%] max-[390px]:top-[50px] max-[834px]:w-[50%] max-[834px]:right-0 max-[834px]:top-[500px]
                                      max-[834px]:right-[-80px]"
                                     data-aos="fade-down"
                                     data-aos-easing="linear"
                                     data-aos-duration="1500"/>
                                <img src={hand2} alt="img" className="absolute right-[-150px]
                            bottom-0 w-[65%] max-md:w-[300px] max-md:right-[-100px] max-[390px]:right-[-40px] max-[390px]:w-[290px] max-[390px]:top-[200px]
                            max-[834px]:w-[350px] max-[834px]:right-[-80px]"
                                     data-aos="fade-up"
                                     data-aos-easing="linear"
                                     data-aos-duration="1500"/>
                            </div>
