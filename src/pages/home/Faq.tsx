        ...
        <section id="faq">
            <div className="container">
                ...
                <div className="flex items-start justify-between relative py-10 flex-wrap ">
                    <div className="max-[390px]:block max-[834px]:flex max-[834px]:flex-row-reverse max-[834px]:items-start max-[834px]:justify-between max-[834px]:w-[100%]">
                        <div className="flex items-center max-[390px]:w-[30%]  max-[390px]:flex-col items-start max-[390px]:w-[23%] max-[834px]:flex-col max-[834px]:mt-32">
                        ...
                        <div className="pb-40">
                            ...
                            <div className="border-l-2 pl-2.5 ">
                                <Fragment>
                                    <div className="md:w-[387px] max-md:w-[60%] max-[390px]:w-[90%]  mb-2.5  rounded  flex items-center justify-center flex-col">
                    ...
                    <div className="">
                        <div className="border-l-2 flex items-start pl-2.5 max-[834px]:w-[60%] max-[834px]:top-[700px]
                         max-[834px]:right-[267px] absolute right-0 top-[-110px] max-[390px]:w-[100%] max-[390px]:right-0 max-[390px]:top-[-70px]">
                            <h1>•</h1>
                        ...
                        <div className="">
                            ...
                            <img src={iphone} alt="img"
                                 className="absolute right-[-152px] top-10
                                      max-[390px]:right-[-38px] max-[390px]:w-[80%] max-[390px]:top-[190px] max-[834px]:w-[50%] max-[834px]:right-0 max-[834px]:top-[500px]
                                      max-[834px]:right-[-80px]"
                                 data-aos="fade-down"
                                 data-aos-easing="linear"
                                 data-aos-duration="1500"/>
                            <img src={hand2} alt="img" className="absolute right-[-150px]
                            bottom-0 w-[65%] max-md:w-[300px] max-md:right-[-100px] max-[390px]:right-[-40px] max-[390px]:w-[290px] max-[390px]:top-[330px]
